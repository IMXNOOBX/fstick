...
const struct IrCode code_eu004Code = {
	...
	3,	 // # of bits per index
	code_eu004Times,
	code_eu004Codes}; // Duplicate IR Code? Similar to NA002
...
const struct IrCode code_eu007Code = {
	...
	2,	// # of bits per index
	code_eu007Times,
	code_eu007Codes}; // Duplicate IR Code? - Similar to NA010
...
const struct IrCode code_eu015Code = {
	...
	3,	 // # of bits per index
	code_eu015Times,
	code_eu015Codes}; // Duplicate IR Code? - Similar to NA018
...
const struct IrCode code_eu030Code = {
	...
	3,	// # of bits per index
	code_na004Times,
	code_eu030Codes}; // Duplicate IR Code? - Smilar to NA020
...
const struct IrCode code_eu051Code = {
	...
	3,	// # of bits per index
	code_eu051Times,
	code_eu051Codes}; // Duplicate IR Code? - Similar to NA115
...
const struct IrCode code_eu052Code = {
	...
	2,	// # of bits per index
	code_eu052Times,
	code_eu052Codes}; // Duplicate IR Code? -  Similar to EU017
...
const struct IrCode code_eu059Code = {
	...
	2, // # of bits per index
	code_eu059Times,
	code_eu059Codes}; // Duplicate IR Code? - Similar to EU056
...
uint16_t powerCodesCount = (sizeof(powerCodes) / sizeof(powerCodes[0]));